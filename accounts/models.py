...
class User(AbstractBaseUser):
  ...
  first_name =models.CharField(max_length =50,default='Muzaffar96',blank=True,null=True)
  last_name =models.CharField(max_length =50,default='Tursunov',blank=True,null=True)
